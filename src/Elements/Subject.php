 ...
 */
class Subject implements ElementInterface
{
    ...
    {
        return [
            static::REQUEST_ID => ParameterType::STRING,
            static::LAST_UPDATE => ParameterType::DATE,
            static::ENTITY => ParameterType::STRING,
            static::GENDER => ParameterType::INTEGER,
            static::SURNAME_UA => ParameterType::STRING,
            static::SURNAME_RU => ParameterType::STRING,
            static::SURNAME_EN => ParameterType::STRING,
            static::NAME_UA => ParameterType::STRING,
            static::NAME_RU => ParameterType::STRING,
            static::NAME_EN => ParameterType::STRING,
            static::PATRONYMIC_UA => ParameterType::STRING,
            static::PATRONYMIC_RU => ParameterType::STRING,
            static::PATRONYMIC_EN => ParameterType::STRING,
            static::CLASSIFICATION => ParameterType::INTEGER,
            static::BIRTH_SURNAME_UA => ParameterType::STRING,
            static::BIRTH_SURNAME_RU => ParameterType::STRING,
            static::BIRTH_SURNAME_EN => ParameterType::STRING,
            static::BIRTH_DATE => ParameterType::DATE,
            static::BIRTH_PLACE_UA => ParameterType::STRING,
            static::BIRTH_PLACE_RU => ParameterType::STRING,
            static::BIRTH_PLACE_EN => ParameterType::STRING,
            static::RESIDENCY => ParameterType::INTEGER,
            static::CITIZENSHIP => ParameterType::STRING,
            static::NEGATIVE_STATUS => ParameterType::INTEGER,
            static::EDUCATION => ParameterType::INTEGER,
            static::MARITAL_STATUS => ParameterType::INTEGER,
            static::STATUS_ID => ParameterType::INTEGER,
            static::FULL_NAME_UA => ParameterType::STRING,
            static::FULL_NAME_RU => ParameterType::STRING,
            static::FULL_NAME_EN => ParameterType::STRING,
            static::ABBREVIATION_NAME_UA => ParameterType::STRING,
            static::ABBREVIATION_NAME_RU => ParameterType::STRING,
            static::ABBREVIATION_NAME_EN => ParameterType::STRING,
            static::OWNERSHIP => ParameterType::INTEGER,
            static::REGISTRATION_DATE => ParameterType::DATE,
            static::ECONOMIC_ACTIVITY => ParameterType::INTEGER,
            static::EMPLOYEE_COUNT => ParameterType::INTEGER,
        ];
    }
