        ...
        $this->assertEquals(
            new Pvbki\StatementReport(
                ...
                new Pvbki\Collections\Communications([
                    new Pvbki\Elements\Communication('+380990080416', 3)
                ]),
                ...
                new Pvbki\Collections\Summaries([
                    new Pvbki\Elements\Summary('roleId', 1, null, 1, null),
                    new Pvbki\Elements\Summary('phaseId', 5, null, 1, null),
                    new Pvbki\Elements\Summary('currency', null, 'UAH', 1, null),
                    new Pvbki\Elements\Summary('type', null, 'instalment', 1, null),
                    new Pvbki\Elements\Summary('totalAmount', null, 'UAH', 1, 6500.0000),
                    new Pvbki\Elements\Summary('restAmount', null, 'UAH', null, 0.0000),
                    new Pvbki\Elements\Summary('overdueAmount', null, 'UAH', null, 0.0000),
                    new Pvbki\Elements\Summary('event', null, 'request', 254, null),
                ]),
